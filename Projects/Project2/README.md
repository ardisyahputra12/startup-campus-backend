...
To test your general understanding and ability to create simple web applications using Flask
and database system in a simplified, real life scenario.
...
- Input `project-2` on the Branch name, make sure you are creating from `main` branch and then click `Create branch`
...
To test locally, go to the relative path for Project2
```
cd
cd startup-campus-backend/Projects/Project2
```
